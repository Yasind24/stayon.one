      ...
      <div className="container mx-auto px-4 py-4 sm:py-8">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-4 sm:p-8">
          ...
          <div className="space-y-6 text-sm sm:text-base text-gray-600">
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3">Agreement to Terms</h2>
              <p>
                By accessing or using Stayon.one, you agree to be bound by these Terms of Service and all
